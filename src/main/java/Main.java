...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if(in.next().equals("y")) {
            ...
            if (userCar != null) {
                ...
                userCar.setPosition(carRace.getRoad().getVectors().get(0));
            ...
            double totalDistance = carRace.getRoad().getTotalDistance();
                ...
                if(in.next().equals("f")){
                    ...
                    for (int i = 0; i < cars.size(); i++){
                        ...
                        double minFrictionCoef = currentCar.getWheels()
                                .stream().min(Comparator.comparing(Wheel::getFriction))
                                .get().getFriction();
                        ...
                        RoutePoint prevPoint = carRace.getRoad().getVectors().get(carProgressPoint[i]);
                        RoutePoint nextPoint = carRace.getRoad().getVectors().get(carProgressPoint[i] + 1);
    ...
    private static void rescaleFrictionCoef(CarRace carRace, Car car, int progressPoint){
        float materialFrictionCoef = carRace.getRoad()
                .getVectors()
                .get(progressPoint)
                .getMaterialState()
                .getFrictionCoef();
        ...
        for (Wheel wheel : car.getWheels() ){
            ...
            wheel.setFriction( wheel.getFriction() * (materialFrictionCoef + rand) );
        }
